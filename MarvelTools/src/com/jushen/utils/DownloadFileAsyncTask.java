...
//        {
//        	m_DownloadPath = params[0];
//            //    通过Apache的HttpClient来访问请求网络中的一张图片
//            HttpClient httpClient = new DefaultHttpClient();
//            HttpGet httpGet = new HttpGet(m_DownloadPath);
//            byte[] image = new byte[]{};
//            try
//            {
...
//            LoggerUtils.i("onPostExecute tag:" + mTag + " len:" + result.length);
//            //    将doInBackground方法返回的byte[]解码成要给Bitmap
//           // Bitmap bitmap = BitmapFactory.decodeByteArray(result, 0, result.length);
//            //    更新我们的ImageView控件
//          //  if(_ImageView != null)
//           // 	_ImageView.setImageBitmap(vBitmap);
//        }
////        DownloadFileAsyncTask aDownloadFileAsyncTask = new DownloadFileAsyncTask();
////		aDownloadFileAsyncTask.execute(temp).get();返回byte[]
//    }
